	...
	<div class="row">
		<div class="col-md-8">
			<div class="form-group">
				...
				<input type="text" id="txt_name" name="txt_name" class="form-control required" value="" placeholder="Tên loại sản phẩm">
			</div>
			...
			<div class="form-group">
				<label>Mô tả</label>
				<textarea class="form-control" name="txt_intro" placeholder="Mô tả về loại sản phẩm..." rows="2"></textarea>
			</div>
		</div>
	...
	$(document).ready(function(){
		...
		$("form#frm_action").submit(function(e) {
			if(validForm()){
				...
				var _url="<?php echo ROOTHOST;?>ajaxs/product_type/process_add.php";
				$.ajax({
					url: _url,
					type: 'POST',
					data: formData,
