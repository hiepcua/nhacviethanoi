...
$sql = "SELECT * FROM `tbl_album` WHERE id = ".$id." ORDER BY `name` DESC";
$objmysql->Query($sql);
...
<div id="path">
    <ol class="breadcrumb">
        ...
        <li class="active">Cập nhật thư viện ảnh</li>
    </ol>
</div>
                ...
                <form id="frm_action" name="frm_action" method="post" action=""  enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-3 form-control-label">Tên Album *</label>
                            <div class="col-sm-9">
                        ...
                        <div class='form-group row'>
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-sm-9">
                                        <input name="txtthumb" type="text" id="file-thumb" class='form-control' value="<?php echo $row['thumb'];?>" placeholder='' />
                                    </div>
                                    <div class="col-sm-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="txt_intro" id="txt_intro" style="min-height: 80px" class="form-control" placeholder="Mô tả về album"><?php echo stripslashes($row['intro']);?></textarea>
                        </div>
        ...
        <div class="tab-pane fade" id="about">
            <form id="frm-upload-img" class="" enctype="multipart/form-data">
                ...
                <div class="box-select" style="margin-bottom: 12px;">
                    <div class="col-md-6">
                        <div class="form-group">
                            <h4 class="form-control-label" style="margin-bottom: 15px; margin-top: 0px;">Upload thư viện ảnh</h4>
                            <div class="row">
