...
if(isset($_POST['cmdsave_tab1']) && $_POST['txt_name']!='') {
	...
	if(isset($_FILES['txt_thumb']) && $_FILES['txt_thumb']['size'] > 0){
		$save_path 	= MEDIA_HOST."/tags/";
		$obj_upload->setPath($save_path);
		$file = ROOTHOST_WEB.'medias/tags/'.$obj_upload->UploadFile("txt_thumb", $save_path);
	}
...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Thêm mới tag</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>">Bảng điều khiển</a></li>
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST.COMS;?>">Danh sách tag</a></li>
				...
				<form name="frm_action" id="frm_action" action="" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-8 col-lg-9">
							...
							<div class="form-group">
								<label>Mô tả</label>
								<textarea class="form-control" name="txt_intro" placeholder="Mô tả về tag..." rows="3"></textarea>
							</div>
						</div>
