...
if(isset($_POST['cmdsave_tab1']) && $_POST['txt_name']!='') {
	...
	$result = SysEdit('tbl_tag', $arr, " id=".$GetID);
...
$res_Cate = SysGetList('tbl_tag', array(), ' AND id='. $GetID);
if(count($res_Cate) <= 0){
					...
					<div class="row">
						<div class="col-md-8 col-lg-9">
							<div class="form-group">
								...
								<input type="text" id="txt_name" name="txt_name" class="form-control" value="<?php echo $row['title'];?>" placeholder="Tiêu đề tag">
							</div>
							...
							<div class="form-group">
								<label>Mô tả</label>
								<textarea class="form-control" name="txt_intro" placeholder="Mô tả về tag..." rows="3"><?php echo $row['intro'];?></textarea>
							</div>
						</div>
