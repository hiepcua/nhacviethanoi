...
include_once('../../libs/cls.account.php');
$base_path = "../../images/";
$root_base_path = ROOTHOST."images/";
$dirname = "images"; 
$supplier_id = 0;
if(isset($_SESSION['SUPPLIER_ID'])) $supplier_id=$_SESSION['SUPPLIER_ID'];
if($supplier_id!=0) {
	$objacc = new CLS_ACCOUNT;
	$user = $objacc->getUser($supplier_id,2);
	$dirname = $user;
	$base_path = "../../uploads/".$user."/";
	$root_base_path = ROOTHOST."uploads/".$user."/";
}
define("BASE_PATH",$base_path);
define("ROOT_BASE_PATH",$root_base_path);
...
if(isset($_FILES["txt_video"])){
	...
	$file=$objmedia->UploadFileResize("txt_video",$cur_dir);
}
if(isset($_GET["file"])){
			...
			<td width="50%" rowspan="2" valign="top">
				...
				<td style="height:30px;"><form id="frm_filter" name="frm_filter" method="post" action="" style="margin:0px; padding:0px;">
					...
					<select name="cbo_dir" id="cbo_dir" onchange="document.frm_filter.submit();">
						<option value="<?php echo BASE_PATH;?>"><?php echo $dirname;?></option>
				...
				<td valign="top" class="list_file">
					<div id="dsfile"><table width="100%" border="0" cellspacing="0" cellpadding="3" class="list">
						<tr>
							...
							<td width="50" align="center"><strong>Xóa</strong></td>
						</tr>
