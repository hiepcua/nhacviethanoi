...
$res_cons = SysGetList('tbl_event', [], "AND id='".$get_id."'");
if(count($res_cons) <= 0){
	echo "Không có dữ liệu";
	exit();
}
$row = $res_cons[0];
$res_cates = SysGetList('tbl_event_group', [], "AND id='".$row['group_id']."'");
	...
	<div class="container page">
		<div class="page-article">
			...
			<div class="main-content">
				...
				<?php
				$res_relateds = SysGetList('tbl_event', [], "AND id <> ".$get_id." AND cat_id=".$res_cate['id']." AND isactive=1 LIMIT 0,3");
