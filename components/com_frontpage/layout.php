		...
		<div class="row"> 
			<div class="col-md-6 col-12"> 
				<a href="<?php echo ROOTHOST;?>khuyen-mai" title="Thiên Thanh">
					<img width="680" height="226" class="lazy loaded" src="//bizweb.dktcdn.net/100/418/839/themes/808559/assets/feature_banner_1.jpg" alt="Thiên Thanh" data-was-processed="true"> 
				</a> 
			</div> 
			<div class="col-md-6 col-12"> 
				<a href="<?php echo ROOTHOST;?>khuyen-mai" title="Thiên Thanh">
					<img width="680" height="226" class="lazy loaded" src="//bizweb.dktcdn.net/100/418/839/themes/808559/assets/feature_banner_2.jpg" alt="Thiên Thanh" data-was-processed="true"> 
				</a> 
			</div> 
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-9 fix-width-right">
					...
					foreach ($res_ptype_loa as $key => $value) {
						$current = $key == 0 ? 'current' : '';
						echo '<div class="tab-'.$key.' tab-content '.$current.'">';
						echo '</div>';
					}
					?>
...
<section class="awe-section-8">
	<div class="container section_banner_evo_2"> 
		<a href="/collections/all" title="Thiên Thanh"> 
			<img width="1920" height="432" class="lazy loaded" src="//bizweb.dktcdn.net/100/418/839/themes/808559/assets/feature_banner_0.jpg" alt="Thiên Thanh"> 
		</a> 
	</div>
</section>
		...
		<div class="news-content row">
			...
			if(count($res_contents)>0){
				foreach ($res_contents as $key => $value) {
					if($key<4){
						$title = $value['title'];
						$link = ROOTHOST.'tin-tuc/'.$value['alias'].'.html';
						$thumb = getThumb('', '', '');
