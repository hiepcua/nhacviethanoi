...
function paging($total_rows,$max_rows,$cur_page){
	...
	if($cur_page >1){
		$paging.='<li class="page-item"><a class="page-link" href="javascript:gotopage('.($cur_page-1).')"> < Trước </a></li>';
	}
	if($max_pages>1){
		for($i=$start;$i<=$end;$i++)
		{
	...
	if($cur_page <$max_pages)
		$paging.='<li class="page-item"><a class="page-link" href="javascript:gotopage('.($cur_page+1).')"> Sau > </a></li>';
